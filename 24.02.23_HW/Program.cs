...
namespace _24._02._23_HW
{
    internal class Program
    {
        ...
        public class Human
        {
            ...
            public Human(string name, string surname , Gender gender, string passport, string address)
            {
                Name = name;
                Surname = surname;
                Gender = gender;
        ...
        public class Student : Human
        {
            ...
            public Student(string name, string surname, Gender gender, string passport, string address, Group group, List<Parents> parents) : base(name, surname, gender, passport, address)
            {
                Group = group;
                Parents = parents;
            }
            public Student(string name, string surname, Gender gender, string passport, string address, Group group) : base(name, surname, gender, passport, address)
            {
                Group = group;
                Parents = null;
            }
        ...
        public class Teachers : Human
        {
            ...
            public Teachers(string name, string surname, Gender gender, string passport, string address, Department department, Type position) : base(name, surname, gender, passport, address)
            {
        ...
        public class Parents : Human
        {
            ...
            public Parents(string name, string surname, Gender gender, string passport, string address, List<Student> children) : base(name, surname, gender, passport, address)
            {
                Children = children;
            }
            public override string ToString()
